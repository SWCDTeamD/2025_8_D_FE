...
export const mockPanelData: PanelData[] = [
  ...
  { panel_uid: "P018", age: 37, gender: "남성", region_city: "인천", region_district: "연수구", region: "인천", marital_status: "기혼", children_count: 2, family_members: 4, education: "대졸", job: "회사원", occupation: "회사원", monthly_personal_income: "400-500만원", monthly_household_income: "600-700만원", income_level: "중", phone_brand: "삼성", phone_model: "갤럭시 S22", car_ownership: "유", car_manufacturer: "현대", car_model: "아반떼", owned_electronics: "노트북", smoking_experience: "현재 흡연", smoking: true, smoking_brands: "에쎄", heated_tobacco_brands: "아이코스", drinking_experience: "소주, 기타", ott_service: false },
